<div class="sliderclass kad-desktop-slider kt-full-slider-container">
    ...
    <div id="full_imageslider" class="kt-full-slider">
        <div class="flexslider kt-flexslider loading" data-flex-speed="<?php echo esc_attr($pausetime); ?>"
             data-flex-anim-speed="<?php echo esc_attr($transtime); ?>"
             data-flex-animation="<?php echo esc_attr($transtype); ?>"
            ...
            <ul class="slides">
                <?php foreach ($slides as $slide) :
                    ...
                    <li>
                        ...
                        <div class="kt-flex-fullslide"
                             style="background-image:url(<?php echo esc_url($slide['url']); ?>); height:<?php echo esc_attr($slideheight); ?>px;">
                            <?php if ($captions == '1'): ?>
                            <div class="flex-caption" style="height:<?php echo esc_attr($slideheight); ?>px;">
                                <div class="flex-caption-case" style="height:<?php echo esc_attr($slideheight); ?>px;">
                                    ...
                                    if (!empty($slide['description'])) :
                                        echo '<div class="captiontext headerfont">';
